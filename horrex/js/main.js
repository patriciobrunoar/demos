(() => {
  ...
  const parallaxTargets = Array.from(document.querySelectorAll(
    '.hero-media img, .hero-bg, .about-visual img, .marine img, .cta-media img, [data-speed], [data-parallax]'
  ));
  ...
  const sections = ['home', 'about', 'products', 'marine', 'dealers', 'contact']
  ...
  /* ---------- Legal / social links (not part of this concept redesign) ---------- */
